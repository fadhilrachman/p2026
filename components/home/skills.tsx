...
import { ABOUT, MENULINKS, SKILLS } from "../../constants";
    ...
    <>
      ...
      >
        {skills.map((skill) => (
          <span
            key={skill}
            className="flex items-center justify-center min-w-20 h-12 px-4 mr-4 mb-4 rounded bg-gray-800 text-gray-100 text-sm font-medium border border-gray-700"
          >
